...
class T1VolumeRegisterDartel(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the T1VolumeExistingDartel pipeline.
    """
    ...
    def build_core_nodes(self):
        ...
        import clinicaml.pipelines.t1_volume_register_dartel.t1_volume_register_dartel_utils as utils
