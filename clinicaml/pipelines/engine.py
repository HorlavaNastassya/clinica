...
Subclasses are located in clinicaml/pipeline/<pipeline_name>/<pipeline_name>_pipeline.py
"""
...
class Pipeline(Workflow):
    ...
    def __init__(
        ...
        from clinicaml.utils.inputs import check_bids_folder, check_caps_folder
    ...
    def run(self, plugin=None, plugin_args=None, update_hash=False, bypass_check=False):
        ...
        from clinicaml.utils.stream import cprint
        from clinicaml.utils.ux import print_failed_images
    ...
    def check_dependencies(self):
        ...
        Returns:
            self: A Pipeline object.
        """
        import clinicaml.utils.check_dependency as chk
    ...
    def update_parallelize_info(self, plugin_args):
        ...
        given the number of CPUs of the machine in which clinicaml is running.
        ...
        try:
            ...
            if n_thread_cmdline > n_cpu:
                cprint(
                    f"{Fore.YELLOW}[Warning] You are trying to run clinicaml "
    ...
    def check_not_cross_sectional(self):
        ...
        sectional, clinicaml proposes to convert it in a clinicaml compliant form.
        ...
        def convert_cross_sectional(bids_in, bids_out, cross_subjects, long_subjects):
            ...
            longitudinal clinicaml-compliant dataset
        ...
        if self.bids_directory is not None:
            ...
            if len(cross_subj) > 0:
                ...
                if answer.lower() == "no":
                    ...
                    cprint(
                        "{Fore.GREEN}Conversion succeeded. Your clinicaml-compliant"
