...
class T1VolumeParcellation(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the T1VolumeParcellation pipeline.
    """
    ...
    def check_pipeline_parameters(self):
        ...
        from clinicaml.utils.atlas import T1_VOLUME_ATLASES
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.input_files import t1_volume_template_tpm_in_mni
