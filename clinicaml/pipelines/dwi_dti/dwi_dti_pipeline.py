...
class DwiDti(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the DwiDti pipeline.
    ...
    def build_core_nodes(self):
        ...
        import nipype.interfaces.utility as nutil
        import nipype.pipeline.engine as npe
        from clinicaml.lib.nipype.interfaces.mrtrix3.utils import TensorMetrics
        from clinicaml.lib.nipype.interfaces.mrtrix.preprocess import DWI2Tensor
