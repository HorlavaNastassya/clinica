...
class DwiPreprocessingUsingPhaseDiffFieldmap(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the DWIPreprocessingUsingPhaseDiffFieldmap pipeline.
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.dwi import check_dwi_volume
        from clinicaml.utils.inputs import clinica_file_reader
        import clinicaml.pipelines.dwi_preprocessing_using_phasediff_fieldmap.dwi_preprocessing_using_phasediff_fieldmap_utils as utils
        from clinicaml.utils.exceptions import ClinicaBIDSError, ClinicaException
        import clinicaml.utils.input_files as input_files
        from clinicaml.utils.stream import cprint
    ...
    def build_output_node(self):
        ...
        from clinicaml.utils.nipype import fix_join
        import clinicaml.pipelines.dwi_preprocessing_using_phasediff_fieldmap.dwi_preprocessing_using_phasediff_fieldmap_utils as utils
    ...
    def build_core_nodes(self):
        ...
        from clinicaml.utils.dwi import prepare_reference_b0
        from clinicaml.workflows.dwi_preprocessing import ecc_pipeline
        from clinicaml.workflows.dwi_preprocessing import hmc_pipeline
        from clinicaml.workflows.dwi_preprocessing import remove_bias

        import clinicaml.pipelines.dwi_preprocessing_using_phasediff_fieldmap.dwi_preprocessing_using_phasediff_fieldmap_workflows as workflows
