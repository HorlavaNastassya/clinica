...
class StatisticsVolumeCorrection(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the StatisticsVolumeCorrection pipeline.
    """
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.inputs import clinica_group_reader
    ...
    def build_core_nodes(self):
        ...
        import clinicaml.pipelines.statistics_volume_correction.statistics_volume_correction_utils as utils
        from clinicaml.utils.inputs import RemoteFileStructure, fetch_file
