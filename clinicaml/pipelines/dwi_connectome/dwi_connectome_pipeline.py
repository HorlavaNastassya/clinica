...
class DwiConnectome(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the DwiConnectome pipeline.
    """
    ...
    def build_output_node(self):
        ...
        import clinicaml.pipelines.dwi_connectome.dwi_connectome_utils as utils
    ...
    def build_core_nodes(self):
        ...
        from clinicaml.lib.nipype.interfaces.mrtrix.preprocess import MRTransform
        from clinicaml.lib.nipype.interfaces.mrtrix3.reconst import EstimateFOD
        from clinicaml.lib.nipype.interfaces.mrtrix3.tracking import Tractography
        from clinicaml.utils.exceptions import ClinicaException, ClinicaCAPSError
        from clinicaml.utils.stream import cprint
        import clinicaml.pipelines.dwi_connectome.dwi_connectome_utils as utils
        from clinicaml.utils.mri_registration import convert_flirt_transformation_to_mrtrix_transformation
