...
class T1VolumeTissueSegmentation(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the T1VolumeTissueSegmentation pipeline.
    """
    ...
    def check_pipeline_parameters(self):
        ...
        from clinicaml.utils.spm import get_tpm
    ...
    def build_core_nodes(self):
        ...
        from clinicaml.utils.filemanip import unzip_nii, zip_nii
