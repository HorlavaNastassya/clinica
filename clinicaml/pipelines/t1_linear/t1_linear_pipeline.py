...
class T1Linear(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the T1 Linear pipeline.
    """
    ...
    def get_processed_images(caps_directory, subjects, sessions):
        ...
        from clinicaml.utils.input_files import T1W_LINEAR_CROPPED
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.filemanip import extract_subjects_sessions_from_filename
        from clinicaml.utils.input_files import T1W_NII
        from clinicaml.utils.inputs import (
            RemoteFileStructure,
            clinica_file_reader,
            fetch_file,
        )
    ...
    def build_output_node(self):
        ...
        from clinicaml.utils.nipype import container_from_filename, fix_join
    ...
    def build_core_nodes(self):
        ...
        from clinicaml.utils.filemanip import get_filename_no_ext
