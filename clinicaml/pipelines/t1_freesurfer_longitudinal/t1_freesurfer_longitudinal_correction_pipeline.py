...
class T1FreeSurferLongitudinalCorrection(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the T1FreeSurferLongitudinalCorrection pipeline
    """
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.input_files import T1_FS_DESTRIEUX, T1_FS_T_DESTRIEUX
