...
class T1FreeSurferTemplate(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the T1FreeSurferTemplate pipeline.
    """
    ...
    def get_processed_images(caps_directory, subjects, sessions):
        ...
        from clinicaml.utils.input_files import T1_FS_T_DESTRIEUX
        from clinicaml.utils.inputs import clinica_file_reader
        from clinicaml.utils.longitudinal import get_long_id
        from clinicaml.utils.participant import get_unique_subjects
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.input_files import T1_FS_DESTRIEUX
        from clinicaml.utils.inputs import clinica_file_reader
        from clinicaml.utils.longitudinal import (
            get_long_id,
            get_participants_long_id,
            read_sessions,
        )
        from clinicaml.utils.participant import (
            get_unique_subjects,
