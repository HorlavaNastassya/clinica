...
class SpatialSVM(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the SpatialSVM pipeline.
    """
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.ux import print_groups_in_caps_directory
    ...
    def build_core_nodes(self):
        ...
        import clinicaml.pipelines.machine_learning_spatial_svm.spatial_svm_utils as utils
