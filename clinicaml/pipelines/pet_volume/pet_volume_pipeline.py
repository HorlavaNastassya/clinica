...
class PETVolume(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the PETVolume pipeline.
    """

    def check_pipeline_parameters(self):
        """Check pipeline parameters."""
        from clinicaml.utils.atlas import PET_VOLUME_ATLASES
    ...
    def build_input_node(self):
        ...
        from clinicaml.iotools.utils.data_handling import (
            check_relative_volume_location_in_world_coordinate_system,
        )
        from clinicaml.utils.exceptions import ClinicaException
        from clinicaml.utils.filemanip import save_participants_sessions
        ...
        from clinicaml.utils.pet import get_suvr_mask, read_psf_information
