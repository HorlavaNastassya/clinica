...
class StatisticsVolume(cpe.Pipeline):
    ...
    Returns:
        A clinicaml pipeline object containing the StatisticsVolume pipeline.
    """
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.ux import print_begin_image, print_images_to_process
    ...
    def build_core_nodes(self):
        ...
        import clinicaml.pipelines.statistics_volume.statistics_volume_utils as utils
