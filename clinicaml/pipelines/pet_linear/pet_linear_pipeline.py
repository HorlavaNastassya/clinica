...
class PETLinear(cpe.Pipeline):
    ...
    space computed in clinicaml t1-linear pipeline.
    ...
    Returns:
        A clinicaml pipeline object containing the pet_linear pipeline.
    """
    ...
    def build_input_node(self):
        ...
        from clinicaml.utils.exceptions import (
            ClinicaBIDSError,
            ClinicaException,
            ClinicaCAPSError,
        )
        ...
        from clinicaml.utils.pet import get_suvr_mask

        # from clinicaml.iotools.utils.data_handling import check_volume_location_in_world_coordinate_system
    ...
    def build_core_nodes(self):
        ...
        import nipype.interfaces.utility as nutil
        import nipype.pipeline.engine as npe
        import clinicaml.pipelines.pet_linear.pet_linear_utils as utils
