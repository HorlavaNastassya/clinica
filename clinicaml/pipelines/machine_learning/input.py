...
import clinicaml.pipelines.machine_learning.region_based_io as rbio
import clinicaml.pipelines.machine_learning.tsv_based_io as tbio
import clinicaml.pipelines.machine_learning.vertex_based_io as vtxbio
...
class CAPSVoxelBasedInput(CAPSInput):
    ...
    def get_images(self):
        ...
        Returns: a list of filenames
        """
        from clinicaml.utils.input_files import pet_volume_normalized_suvr_pet
...
class CAPSRegionBasedInput(CAPSInput):
    def __init__(self, input_params):
        from clinicaml.utils.atlas import VOLUME_ATLASES
