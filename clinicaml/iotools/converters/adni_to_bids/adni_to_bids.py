...
from clinicaml.iotools.abstract_converter import Converter
...
class AdniToBids(Converter):
    ...
    def check_adni_dependencies(self):
        ...
        from clinicaml.utils.check_dependency import check_dcm2nii, check_dcm2niix
    ...
    def convert_clinical_data(self, clinical_data_dir, out_path):
        ...
        import clinicaml.iotools.converters.adni_to_bids.adni_utils as adni_utils
        import pandas as pd
    ...
    def convert_images(
        ...
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_av45_fbb_pet as adni_av45_fbb
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_dwi as adni_dwi
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_fdg_pet as adni_fdg
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_flair as adni_flair
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_fmri as adni_fmri
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_pib_pet as adni_pib
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_t1 as adni_t1
        import clinicaml.iotools.converters.adni_to_bids.adni_modalities.adni_tau_pet as adni_tau
        import pandas as pd
        from clinicaml.utils.stream import cprint
        ...
        if only_existing_data == True or subjs_list_path is not None :
            ...
            if subjs_list_path is not None and only_existing_data == False :
                ...
                subjs_list =list(set([x.name for x in os.scandir(source_dir)]))
