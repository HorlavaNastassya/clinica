...
def prepare_b0(num_b0s, low_bval=5, name="prepare_b0"):
    ...
    from clinicaml.utils.dwi import b0_dwi_split, insert_b0_into_dwi
...
def b0_flirt_pipeline(num_b0s, name="b0_coregistration"):
    ...
    from clinicaml.utils.dwi import merge_volumes_tdim
...
def hmc_pipeline(name="motion_correct"):
    ...
    from clinicaml.utils.dwi import hmc_split, merge_volumes_tdim
    from clinicaml.workflows.dwi_preprocessing import dwi_flirt
...
def eddy_fsl_pipeline(epi_param, name="eddy_fsl"):
    ...
    from clinicaml.pipelines.dwi_preprocessing_using_t1.dwi_preprocessing_using_t1_utils import (
        b0_indices,
        eddy_fsl,
        generate_acq,
        generate_index,
