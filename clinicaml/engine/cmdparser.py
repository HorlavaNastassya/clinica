...
class CmdParser:
    ...
    For pipelines, please use the 'clinicaml generate template' command.
    For converters, see clinicaml/iotools/converters/*/*_cli.py
    For iotools, see clinicaml/iotools/utils/data_handling_cli.py
    """
